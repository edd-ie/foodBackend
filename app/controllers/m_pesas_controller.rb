class MPesasController < ApplicationController
    ...
    def stkpush 
        ...
        payload = {
            ...
            'CallBackURL': "https://1b17-102-220-169-34.ngrok-free.app/callback",
    ...
    def callback
        ...
        CallbackUrl.create!(customer_id: customer_id, trans_id: transaction_id, trans_amount: transaction_amount,
    ...
    def generate_access_token_request
        ...
        @customerpass = Base64.strict_encode64("#{@consumer_key}:#{@consumer_secret}")
        @headers = {
          Authorization: "Basic #{@customerpass}", # Change @userpass to @customerpass
          'Content-Type': 'application/json'
        }
      
        pp @customerpass, @consumer_key, @consumer_secret
      
        res = RestClient::Request.execute(url: @url, method: :get, headers: @headers)
        pp @url, @headers, res # Print out URL, headers, and response for debugging
